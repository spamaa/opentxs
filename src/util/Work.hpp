...
constexpr auto OT_ZMQ_FILTER_ORACLE_READY =                     OTZMQWorkType{OT_ZMQ_HIGHEST_SIGNAL - 21};
constexpr auto OT_ZMQ_FILTER_ORACLE_INDEXER_READY =             OTZMQWorkType{OT_ZMQ_HIGHEST_SIGNAL - 22};
constexpr auto OT_ZMQ_FILTER_ORACLE_FILTER_DOWNLOADER_READY =   OTZMQWorkType{OT_ZMQ_HIGHEST_SIGNAL - 23};
constexpr auto OT_ZMQ_FILTER_ORACLE_HEADER_DOWNLOADER_READY =   OTZMQWorkType{OT_ZMQ_HIGHEST_SIGNAL - 24};
...
constexpr auto OT_ZMQ_BLOCK_BATCH_JOB_AVAILABLE =               OTZMQWorkType{OT_ZMQ_HIGHEST_SIGNAL - 29};

...
#include "network/otdht/client/Server.hpp"  // IWYU pragma: associated
...
namespace opentxs::network::otdht::client
{
...
auto Server::ProcessState(const opentxs::network::otdht::State& state) noexcept
    -> Height
{
